...
avoid loosing battles and do winning battles with cannon fodder to absorb the hits.
But you'll need to replace that cannon fodder.

Make sure their reinforcements arrive in time,
...
For example, from Berlin to Moscow at infantry speed (without transports) takes 5 rounds:
